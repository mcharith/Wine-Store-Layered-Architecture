...
public class PlaceOrderFormController {
    ...
    PurcheseOrderBO purcheseOrderBO = (PurcheseOrderBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.ORDERDETAILS);
   ...
   public void initialize() throws ClassNotFoundException {
    ...
    private void getCurrentOrderId() throws ClassNotFoundException {
        try {
            String currentId = purcheseOrderBO.generateNewID();
   ...
   public void btnPlaceOrderOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        ...
        try {
            boolean isPlaced = saveOrders(orderID,cusId,date,tblOrder.getItems().stream().map(cartTm -> new OrderDetailDTO(orderID,
                    cartTm.getCode(),cartTm.getQty(),cartTm.getUnitPrice())).collect(Collectors.toList()));
            //System.out.println(isPlaced);
            if(isPlaced){
                new Alert(Alert.AlertType.CONFIRMATION,"Order Placed!").show();
            }else {
                new Alert(Alert.AlertType.WARNING,"Order Placed Unsuccefully!").show();
            }
        }catch (SQLException e){
            new Alert(Alert.AlertType.ERROR,e.getMessage()).show();
        }
    }
   public boolean saveOrders(String orderId, String customerId, Date orderDate, List<OrderDetailDTO>orderDetailDTOS) throws SQLException, ClassNotFoundException {
        OrderPlaceDTO orderDTO = new OrderPlaceDTO(orderId,customerId,orderDate,orderDetailDTOS);
        return purcheseOrderBO.purchaseOrder(orderDTO);
    }

   public void cmbItemCodeOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
       String code = cmbItemCode.getValue();

       try {
           Item item = purcheseOrderBO.searchById(code);
           if(item != null) {
    ...
    public void txtContactOnAction(ActionEvent actionEvent) throws ClassNotFoundException {

        //System.out.println("1");
        String tele = txtTele.getText();
        if (isValid()) {
            try {
                lk.ijse.entity.Customer customer = purcheseOrderBO.searchByContact(tele);
    ...
    private void getDescription() throws ClassNotFoundException {
        ObservableList<String> obList = FXCollections.observableArrayList();
        try {
            List<String> descriptionList = purcheseOrderBO.getDescription();
    ...
    public void cmbDescriptionOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        String desc = cmbDescription.getValue();
        try {
            lk.ijse.entity.Item item = purcheseOrderBO.searchByDescription(desc);
            if(item != null) {
    ...
    private void getuserName() throws ClassNotFoundException {
        ObservableList<String> obList = FXCollections.observableArrayList();
        try {
            List<String> userNameList = purcheseOrderBO.getuserName();
    ...
    public void cmbUserNameOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        String userName = cmbUserName.getValue();
        try {
            lk.ijse.entity.Staff staff = purcheseOrderBO.searchByUserName(userName);
            if(staff != null) {
