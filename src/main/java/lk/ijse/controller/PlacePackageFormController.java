...
import lk.ijse.dto.PackageDetailsDTO;
...
public class PlacePackageFormController {
    ...
    PurchesePackageBO purchesePackageBO = (PurchesePackageBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.PACKAGEDETAILS);
    ...
    private void getCurrentOrderId() throws ClassNotFoundException {
        try {
            String currentId = purchesePackageBO.generateNewID();
    ...
    public void txtContactOnAction(ActionEvent actionEvent) {
        ...
        if(isValid()) {
            try {
                lk.ijse.entity.Customer customer = purchesePackageBO.searchByContact(tele);
    ...
    public void cmbUserNameOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        ...
        try {
            lk.ijse.entity.Staff staff = purchesePackageBO.searchByUserName(userName);
            if(staff != null) {
    ...
    private void getuserName() throws ClassNotFoundException {
        ...
        try {
            List<String> userNameList = purchesePackageBO.getuserName();
    ...
    public void cmbDescriptionOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        ...
        try {
            Package packages = purchesePackageBO.searchByDescription(desc);
            if(packages != null) {
    ...
    private void getDescription(){
        ObservableList<String> obList = FXCollections.observableArrayList();
        try {
            List<String> descriptionList = purchesePackageBO.getDescription();
    ...
    public void btnPlaceOrderOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        ...
        try {
            ...
            boolean isPlaced = saveOrder(orderID, cusId, date, tblPackageOrder.getItems().stream()
                    .map(packageCartTm -> new PackageDetailsDTO(orderID, packageCartTm.getId(), packageCartTm.getQty(), packageCartTm.getPrice()))
    ...
    public boolean saveOrder(String orderId, String customerId, Date orderDate, List<PackageDetailsDTO> packageDetails) throws SQLException, ClassNotFoundException {
        System.out.println(orderId);
        OrderDTO orderDTO = new OrderDTO(orderId, customerId, orderDate, packageDetails);
        System.out.println(orderDTO);
        return purchesePackageBO.purchasePackage(orderDTO);
    }
