...
public class CustomerFormController {
    ...
    private void loadAllCstomer() {
        ...
        try {
            ...
            for (CustomerDTO customerDTO : allCustomers) {
                tblCustomer.getItems().add(new CustomerTm(customerDTO.getCusId(), customerDTO.getCusName(),
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) {
        ...
        if(isValid()) {
            try {
                boolean isSaved = customerBO.addCustomer(new CustomerDTO(cusId,cusName,cusAddress,cusNum));
                if (isSaved) {
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = customerBO.updateCustomer(new CustomerDTO(cusId,cusName,cusAddress,cusNum));
            if(isUpdated) {
