...
public class StaffFormController {
    ...
    private void loadAllStaff() throws ClassNotFoundException {
        ObservableList<StaffTm>obList = FXCollections.observableArrayList();

        try {
            List<StaffDTO> staffList = staffBO.getAllStaff();
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        ...
        if (isValid()) {
            StaffDTO staff = new StaffDTO(StaffID, Name, Address, Age, ContactNumber, JobPosition);

            try {
                boolean isSaved = staffBO.addStaff(staff);
                if (isSaved) {
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        ...
        try {
            boolean isSaved = staffBO.updateStaff(staff);
            if (isSaved){
