...
public class ItemFormController {
    ...
    private void loadAllItem() throws ClassNotFoundException {
    ...
    private void getSupplierName() throws ClassNotFoundException {
        ObservableList<String> obList = FXCollections.observableArrayList();
        try {
            List<String> supplierNameList = itemBO.getSupplierName();
    ...
    public void cmbSupplierNameOnAction(ActionEvent actionEvent) throws ClassNotFoundException {
        String supplierName = cmbSupplierName.getValue();
        try {
            Supplier supplier = itemBO.searchBySupplierName(supplierName);
            if(supplier != null) {
